      ...
      <div>
        ...
        <div class="contact-wrapper mt-5">
          <v-card class="contact-content">
            <v-form ref="form" v-model="valid" method="post" action="https://api.staticforms.xyz/submit" lazy-validation>
                ...
                <v-col cols="12" sm="6" md="5">
                  <v-row>
                    <v-col>
                      <div class="stamp-container">
                        <div class="text-stamp"><h1>{{ $t("contact-priority") }}</h1></div>
                        <div class="stamp">
                  ...
                  <v-row>
                    <v-col class="d-flex flex-column align-end">
                      <v-btn :disabled="!valid" depressed type="submit" @click="submitForm">{{ $t('contact-send') }}</v-btn>
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
